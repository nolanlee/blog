...
![desktop-prototype-image](/images/01-desktop-opt.webp)

(*对于桌面用户，我们将专注于让用户有怎样花更长时间和精力去交互*)

![mobile-prototype-image](/images/02-mobile-opt.webp)
...
![ann-home](/images/03-memory-opt.webp)
...
![speed-reservation](/images/04-speed-opt.webp)
...
![data-prefetched](/images/05-speed-opt.webp)
